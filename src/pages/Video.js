...
const Video = () => {
    ...
    return (
        <div className='relative h-screen'>
            ...
            {!playing && <div onClick={() => videoHandler()} className=" flex items-center justify-center mt-[-30vw] px-10 z-20">
            ...
            <div className='flex items-center gap-3 absolute top-8 right-8'>
                ...
                <button className='btn-toggle flex justify-center' onClick={() => handleSalma()}><BiFullscreen className='h-5' /></button>
            </div>
        </div>
    );
};
