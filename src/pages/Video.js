...
const Video = () => {
    ...
    return (
        <div className='relative h-screen'>
            ...
            <video onClick={() => videoHandler()} ref={videoref} className='h-screen object-cover cursor-pointer'>
            ...
            {!playing && <div className=" flex flex-col items-center mt-[-50vw] px-10 z-20">
