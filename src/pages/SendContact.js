        ...
        <div className='px-12'>
            ...
            <form className='mt-5' onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <label className='text-sm mb-16' htmlFor="check">
                ...
                {checked ?
                    <a className='btn-secondary w-full block mt-10 py-3' target='_blank' rel="noopener noreferrer" href="https://github.com/omarrfaruk">
                        <span>Send your answer</span>
                        <span><HiOutlineArrowNarrowRight className='inline ml-10' /></span>
                    </a>
                    :
                    <button onClick={() => setError('To continue you must accept the terms & conditions.')} className='btn-secondary w-full py-3 mt-10' type='submit'>
                        <span>Send your answer</span>
                        <span><HiOutlineArrowNarrowRight className='inline ml-10' /></span>
                    </button>
                }
